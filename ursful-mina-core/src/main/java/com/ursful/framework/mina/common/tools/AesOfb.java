...
//        }
    ...
    /**
     * Encrypts <coder>data</coder> and generates a new IV.
     * 
    ...
    /**
     * Generates a packet header for a packet that is <coder>length</coder> long.
     * 
    ...
    /**
     * Gets a new IV from <coder>oldIv</coder>
     * 
    ...
    /**
     * Does funny stuff. <coder>this.OldIV</coder> must not equal
     * <coder>in</coder> Modifies <coder>in</coder> and returns it for
     * convenience.
     * 
     * @param inputByte The byte to apply the funny stuff to.
     * @param in Something needed for all this to occur.
     * @return The modified version of <coder>in</coder>.
     */
