...
public class ClientPacketCreator {
    ...
    public static Packet getClientInfo(Opcode ops, String sid, String cid, String resource, boolean isServer, Map<String, Object> info) {
        ByteWriter writer = new ByteWriter();
        writer.writeShort(ops.ordinal());
        writer.writeString(cid + "@" + sid + ((resource != null&&resource.length() > 0)?("/" + resource):""));
