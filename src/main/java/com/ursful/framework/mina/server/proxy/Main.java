 ...
 *
 */
package com.ursful.framework.mina.server.proxy;
 ...
 * <coder>org.apache.mina.example.proxy.Main 12345 www.google.com 80</coder><br>
...
//        }
        ...
        ClientToProxyIoHandler handler = new ClientToProxyIoHandler( connector,
            new InetSocketAddress("192.168.0.134",  9091) );

        // Start proxy.
        acceptor.setHandler( handler );
        acceptor.bind( new InetSocketAddress("192.168.0.134",9090) );
